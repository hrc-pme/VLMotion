...
configurable_parameters = [
    ...
    {"name": "serial_no", "default": "'239122070936'", "description": "choose device by serial number"},
    ...
    {"name": "depth_module.infra_profile", "default": "640x480x15", "description": "infra streams (0/1/2) profile"},
