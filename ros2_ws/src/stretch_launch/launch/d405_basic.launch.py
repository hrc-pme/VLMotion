...
configurable_parameters = [
    ...
    {"name": "rgb_camera.color_profile", "default": "848x480x10", "description": "color stream profile"},
    ...
    {"name": "depth_module.depth_profile", "default": "848x480x10", "description": "depth stream profile"},
    {"name": "depth_module.depth_format", "default": "Z16", "description": "depth stream format"},
    {"name": "depth_module.infra_profile", "default": "848x480x10", "description": "infra streams (0/1/2) profile"},
